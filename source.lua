...
Title.TextSize = 18
Title.Text = "Infinite Yield FY (fuck you)"
...
CMDs[#CMDs + 1] = {NAME = 'loopreset', DESC = 'Loop kills you'}
...
addcmd('newdex', {'ndex'}, function(args, speaker)
    notify('Loading', 'Hold on a sec')
    loadstring(game:HttpGet("https://raw.githubusercontent.com/agreeed/InfiniteYieldFY/main/dex.lua"))()
end)
